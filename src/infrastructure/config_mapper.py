...
class ConfigurationMapper:
    def __init__(self, env: str) -> None:
        ...
        mvc_source = __config_raw.get("MVC_SOURCE")

        if dog_source is None or cat_source is None or mvc_source is None:
            raise Exception()

        self.config = ConfigurationEntity(dog_source, cat_source, mvc_source, env)
