...
from src.application.repositories.dog_facts.dog_facts_repository_abstract import DogFactsRepositoryAbstract
from src.application.usecases.dog_facts.get_all_dog_facts_usecase import GetAllDogFactsUseCase
from src.application.usecases.dog_facts.get_one_dog_fact_by_id_usecase import GetOneDogFactByIdUseCase
